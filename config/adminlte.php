...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'header' => 'SHAREPOINT AND TRACKERS',
        ...
        [
            'text' => 'Overall IT Asset Allocations',
            'icon' => '',
            'url'  => '/',
        ],
        [
            'text' => 'Returning WAH Device at Work',
            'icon' => '',
            'url'  => '/',
        ],
        [
            'text' => 'Clearance Signatory',
            'icon' => '',
            'url'  => '/',
        ],
        [
            'text' => 'Equipment Delivery Tracker',
            'icon' => '',
            'url'  => '/',
        ],
        [
            'text' => 'Equipment Retrieval Tracker',
            'icon' => '',
            'url'  => '/',
        ],
        [
            'text' => 'WAH Deployment & Provisioning Requests Tracker',
            'icon' => '',
            'url'  => '/',
        ],
        [
            'text' => 'Returning WAH Device at Work Physical Damage Tracker',
            'icon' => '',
            'url'  => '/',
        ],
        [
